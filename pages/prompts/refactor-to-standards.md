---
layout: default
title: Refactor to Standards Prompt
---

# Refactor to Standards Prompt — Example

This is an example `.prompt.md` file for auditing existing code against Defra standards and producing a prioritised refactor plan. Use it when bringing a legacy file up to current standards, before a significant sprint, or as part of a tech debt review.

## Example file contents

The content below goes into your `.github/prompts/refactor-to-standards.prompt.md` file:
