---
layout: default
title: Defra App Developer Agent
---

# Defra App Developer Agent — Example

This is the flagship example agent for Defra projects. It encodes the key guardrails from [Defra software development standards](https://github.com/DEFRA/software-development-standards){:target="_blank"} (opens in new tab) so Copilot produces compliant code by default.
