...
This is an example `.agent.md` file for a code review agent. Its review criteria are drawn from [Defra software development standards](https://github.com/DEFRA/software-development-standards){:target="_blank"} (opens in new tab) — the single source of truth for Defra coding practices. Copy it into `.github/agents/code-reviewer.agent.md` in your repository.
