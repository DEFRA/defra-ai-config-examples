---
layout: default
title: C# Backend Instructions
---

# C# Backend Instructions — Example

This is an example scoped instruction file for C# backend code. It activates when Copilot is working on C# files. The rules are drawn from [Defra software development standards](https://github.com/DEFRA/software-development-standards){:target="_blank"} (opens in new tab) — the single source of truth for Defra coding practices. Copy it into `.github/instructions/csharp-backend.instructions.md` in your repository.
