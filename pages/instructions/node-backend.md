---
layout: default
title: Node.js Backend Instructions
---

# Node.js Backend Instructions — Example

This is an example scoped instruction file for Node.js backend code. It activates when Copilot is working on JavaScript files. The rules are drawn from [Defra software development standards](https://github.com/DEFRA/software-development-standards){:target="_blank"} (opens in new tab) — the single source of truth for Defra coding practices. Copy it into `.github/instructions/node-backend.instructions.md` in your repository.
