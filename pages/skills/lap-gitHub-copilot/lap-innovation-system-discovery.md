...
This is an example Agent Skill that Builds an accurate, evidence-based map of the current system (structure, flows, dependencies, data). Copy it into `.github/skills/{your_file_name}.skill.md` in your repository.
