---
layout: default
title: LAP Implementations Skills — Examples for GitHub Copilot
---
...
| [LAP Innovation Incremental Refactoring]({{ "/pages/skills/lap-gitHub-copilot/lap-innovation-incremental-refactoring" | relative_url }}) | Implement one approved migration slice safely in a factory-compatible way small, reviewable, reversible, and fully tested. |

| [LAP Innovation Intelligent Application Migration]({{ "/pages/skills/lap-gitHub-copilot/lap-innovation-intelligent-application-migration" | relative_url }}) | Implement one approved migration slice safely in a factory-compatible way small, reviewable, reversible, and fully tested. |
