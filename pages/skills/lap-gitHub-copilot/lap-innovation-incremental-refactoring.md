---
layout: default
title: LAP Innovation Incremental Refactoring Skill
---

# Defra Standards Skill — Example

This is an example Agent Skill that Implements one approved migration slice safely in a factory-compatible way small, reviewable, reversible, and fully tested. Copy it into `.github/skills/{your_file_name}.skill.md` in your repository.
